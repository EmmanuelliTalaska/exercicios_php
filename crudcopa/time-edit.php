           ...
           <div class="col-md-12">
               <div class="card">
                   ...
                   <div class="card-body">
                       <?php
                       if(isset($_GET['id'])) {
                           $time_id = mysqli_real_escape_string($con, $_GET['id']);
                           $query = "SELECT * FROM tbtime WHERE id='$time_id' ";
                           ...
                           if(mysqli_num_rows($query_run) > 0) {
                               ...
                               <form action="code.php" method="POST">
                                   ...
                                   <div class="mb-3">
                                       ...
                                       <input type="text" name="numtitulos" value="<?=$time['ntitulos'];?>" class="form-control">
                                   </div>
                                   <div class="mb-3">
