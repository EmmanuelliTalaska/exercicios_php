...
if(isset($_POST['delete_time'])){
   ...
   $query = "DELETE FROM tbtime WHERE id='$time_id' ";
...
if(isset($_POST['update_time'])){
   ...
   $query = "UPDATE tbtime SET time='$time', pais='$pais', numtitulos='$numtitulos', treinador='$treinador', coruniforme='$coruniforme' WHERE id='$time_id' ";
   $query_run = mysqli_query($con, $query);
  if($query_run) {
